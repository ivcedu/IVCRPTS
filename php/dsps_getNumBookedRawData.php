<?php
    ...
    $query_dsps_raw_data = "INSERT INTO #REPORTS SELECT "
                            . "prct.TestDate, "
    ...
    $query_get_result = "SELECT RptYear, RptMonth, RptWeekday, COUNT(*) AS NumBooked "
                        . "FROM #REPORTS "
                        . "WHERE RptStatus = 'Completed' "
                        . "GROUP BY NumWeekday, RptWeekday, NumMonth, RptMonth, RptYear "
                        . "ORDER BY RptYear, NumMonth, NumWeekday ASC";
    
    $dbConn->query($query_create_table);
    $dbConn->query($query_dsps_raw_data);
