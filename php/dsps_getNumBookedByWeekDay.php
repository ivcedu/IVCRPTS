<?php
    ...
    $query_dsps_by_weekday = "INSERT INTO #REPORTS SELECT "
                            . "prct.TestDate, "
    ...
    $query_get_result = "SELECT RptWeekday, COUNT(*) AS NumBooked "
                        . "FROM #REPORTS "
                        . "WHERE RptStatus = 'Completed' "
                        . "GROUP BY NumWeekday, RptWeekday "
                        . "ORDER BY NumWeekday ASC";
    
    $dbConn->query($query_create_table);
    $dbConn->query($query_dsps_by_weekday);
